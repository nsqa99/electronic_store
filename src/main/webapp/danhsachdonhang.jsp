...
<body>
	<div id="Danhsachdonhang">
		<div id="titleDanhsachdonhang">Danh sách đơn hàng</div>
		...
		<div id=menuDanhsachdonhang>
			...
			<div class="dssp">
				...
				<div class=danhsachdonhang>
					...
					<form action="<%=request.getContextPath()%>/DetailOrderServlet"
						method="get">
						<input type="hidden" name="idHD" value=<%=order.getIdOrd()%>>
						<input type="hidden" name="total" value=<%=order.getTotal()%>>
						<input type="hidden" name="date" value=<%=order.getCreatedDate()%>>
